...
public class ShoppingApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * Set<Object> objects=daoGrocery.createCart(shampoo2, toy, biscuit); for
		 * (Object object : objects) { if(object.equals(shampoo)) {
		 * System.out.println("shampoo Item: "+shampoo.getBrand()+", "+shampoo.getColor(
		 * )+", "+shampoo.getPrice()+", "+shampoo.getQuantity()); } }
		 */
		try {
			Shampoo shamapoo1=daoGrocery.createShampoo(shampoo);
			Shampoo shamapoo2=daoGrocery.createShampoo(shampoo2);
		}
		catch(GroceryException g) {
